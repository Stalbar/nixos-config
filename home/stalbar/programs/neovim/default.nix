...
in
{
  ...
  xdg.configFile."nvim/lua/config/theme.lua".source = ./config/nvim/lua/config/theme.lua;

  xdg.configFile."nvim/lua/plugins/init.lua".source = ./config/nvim/lua/plugins/init.lua;
  xdg.configFile."nvim/lua/plugins/editing/init.lua".source =
    ./config/nvim/lua/plugins/editing/init.lua;
  xdg.configFile."nvim/lua/plugins/editing/treesitter.lua".source =
    ./config/nvim/lua/plugins/editing/treesitter.lua;
  xdg.configFile."nvim/lua/plugins/editing/text.lua".source =
    ./config/nvim/lua/plugins/editing/text.lua;
  xdg.configFile."nvim/lua/plugins/editing/snippets.lua".source =
    ./config/nvim/lua/plugins/editing/snippets.lua;
  xdg.configFile."nvim/lua/plugins/refactor/init.lua".source =
    ./config/nvim/lua/plugins/refactor/init.lua;
  xdg.configFile."nvim/lua/plugins/refactor/rename.lua".source =
    ./config/nvim/lua/plugins/refactor/rename.lua;
  xdg.configFile."nvim/lua/plugins/refactor/outline.lua".source =
    ./config/nvim/lua/plugins/refactor/outline.lua;
  xdg.configFile."nvim/lua/plugins/workflow/init.lua".source =
    ./config/nvim/lua/plugins/workflow/init.lua;
  xdg.configFile."nvim/lua/plugins/workflow/sessions.lua".source =
    ./config/nvim/lua/plugins/workflow/sessions.lua;
  xdg.configFile."nvim/lua/plugins/workflow/buffers.lua".source =
    ./config/nvim/lua/plugins/workflow/buffers.lua;
  xdg.configFile."nvim/lua/plugins/workflow/search_replace.lua".source =
    ./config/nvim/lua/plugins/workflow/search_replace.lua;
  xdg.configFile."nvim/lua/plugins/workflow/terminal.lua".source =
    ./config/nvim/lua/plugins/workflow/terminal.lua;
  xdg.configFile."nvim/lua/plugins/workflow/testing.lua".source =
    ./config/nvim/lua/plugins/workflow/testing.lua;
  xdg.configFile."nvim/lua/plugins/workflow/opencode.lua".source =
    ./config/nvim/lua/plugins/workflow/opencode.lua;
  xdg.configFile."nvim/lua/plugins/navigation/init.lua".source =
    ./config/nvim/lua/plugins/navigation/init.lua;
  xdg.configFile."nvim/lua/plugins/navigation/flash.lua".source =
    ./config/nvim/lua/plugins/navigation/flash.lua;
  xdg.configFile."nvim/lua/plugins/navigation/trouble.lua".source =
    ./config/nvim/lua/plugins/navigation/trouble.lua;
  xdg.configFile."nvim/lua/plugins/navigation/todo_comments.lua".source =
    ./config/nvim/lua/plugins/navigation/todo_comments.lua;
  ...
  xdg.configFile."nvim/lua/snippets/typescript.lua".source =
  ...
  xdg.configFile."nvim/lua/plugins/ui/smooth_scroll.lua".source =
    ./config/nvim/lua/plugins/ui/smooth_scroll.lua;
  ...
  xdg.configFile."nvim/lua/plugins/ui/telescope.lua".source =
    ./config/nvim/lua/plugins/ui/telescope.lua;
  xdg.configFile."nvim/lua/plugins/ui/which_key.lua".source =
    ./config/nvim/lua/plugins/ui/which_key.lua;
  ...
  xdg.configFile."nvim/lua/plugins/ui/bufferline.lua".source =
    ./config/nvim/lua/plugins/ui/bufferline.lua;
  xdg.configFile."nvim/lua/plugins/ui/dressing.lua".source =
  ...
  xdg.configFile."nvim/lua/plugins/lsp/lspconfig.lua".source =
  ...
  xdg.configFile."nvim/lua/plugins/lsp/actions.lua".source =
    ./config/nvim/lua/plugins/lsp/actions.lua;
  ...
  xdg.configFile."nvim/lua/plugins/lsp/conform.lua".source =
